...
| `feature/13-player-pool-stats` | Pool cards: tournament stats + form badges | Done (merged, `v0.12.0-pool-stats`) |
| `feature/09-live-score-sync` | CricAPI match data, lock times, score sync jobs | **Next** (last) |
